...
const Home = () => {
  ...
  return (
    <div name='home' className='w-full bg-[black]'>
      ...
      <p className='text-[#8892b0] py-4 mx-auto text-2xl max-w-[500px]'>
          Hi, my name is
        </p>
        ...
        <div>
          <button className='text-white group border-2 px-6 py-3 my-2 mx-auto flex items-center hover:bg-teal-600 hover:border-black-600'>
            Download Resume
